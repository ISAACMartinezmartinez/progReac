...
const Vista = ({setTodos,todos,editar,id, setEditar}) => {
  ...
  <div className="form-group">
    ...
    <input type="text" value={tarea} className="form-control" id="Formulario" placeholder='Ingresar Tarea' onChange={editar ? ((e)=setTarea(tarea.todos)): ((e) => setTarea(e.target.value))} required/>
  </div>
